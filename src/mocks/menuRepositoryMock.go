...
func (m *MockMenuRepository) GetMenu(orderCode string) (model.MenuItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMenu", orderCode)
...
func (mr *MockMenuRepositoryMockRecorder) GetMenu(orderCode interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMenu", reflect.TypeOf((*MockMenuRepository)(nil).GetMenu), orderCode)
}
